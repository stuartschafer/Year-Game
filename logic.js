$(document).ready(function() {
    ...
    $("#video").hide();
    let answerPic = ["bww.jpg", "subway.jpg", "wholefoods.jpg", "tyson.jpg", "hardees.png", "fiveguys.png", "redlobster.jpg", "chipotle.jpg", "ihop.jpg", "chickfila.jpg", "potbelly.jpg"];
    let questions = ["What year did the first BUFFALO WILD WINGS open?",
    ...
    "What year did the first POTBELLY open?"];
    let answers = [1982, 1965, 1980, 1935, 1960, 1986, 1968, 1993, 1958, 1967, 1977];
    let solutions = ["BWW was founded in 1982 by business partners Jim Disbrow and Scott Lowery, who fulfilled a need when they couldn't find classic upstate New York-style chicken wings after relocating from Buffalo to Columbus, Ohio.",
    ...
    $("#firstGuess").click(function() {
        ...
        if (guess < 0 || guess > 2021 || guessStr === "") {
            boo.play();
    ...
    $("#coolInfo").click(function() {
        ...
        $("#timer").hide();
        $("#infoPic").show();
        $("#infoPic").html(solutions[x]);
        $(".ansPic").attr("src", "images/" + answerPic[x]);
        $(".ansPic").show();
    });
    ...
    function awardPoint() {
        ...
        if ((x == 9) && (team1Score === team2Score)) {
            $("#timer").append("<br><br><span id='tie'>WE HAVE A TIE,<br>so 1 more question for a tie-breaker!!! </span><br>" + nextTeam + " will go first");
            showPicAndInfo();
        } else if ((x >= 9) && (team1Score || team2Score)) {
            $("#coolInfo").show();
            ending = "Yes";
            $("#timer").append("<br><br><span id='tie'>That concludes the game.<br>Now to Award the winner.</span><br>");
        } else {
